...
This project extends [FlexKeyLogger](https://github.com/terryyutian/keylogging-demo-webpage) by Terry Y. Tian, which provides the keystroke capture and activity classification infrastructure.
